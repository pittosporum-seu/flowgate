...
class SettingsActivity : BaseActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        private val language by lazy { findPreference<ListPreference>(AppConfig.PREF_LANGUAGE) }
...
//            localDnsPort?.isEnabled = enabled
        ...
        private fun updateHevTunSettings(enabled: Boolean) {
            val useHevTun = enabled && SettingsManager.isUsingHevTun()
            hevTunLogLevel?.isEnabled = useHevTun
            hevTunRwTimeout?.isEnabled = useHevTun
