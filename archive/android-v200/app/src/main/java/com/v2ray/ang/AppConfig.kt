...
object AppConfig {
    ...
    const val PREF_FLOWGATE_AI_PROFILES = "pref_flowgate_ai_profiles"
    const val PREF_FLOWGATE_AI_DEFAULT_PROFILE = "pref_flowgate_ai_default_profile"
    const val PREF_FLOWGATE_AI_FALLBACK_PROFILE = "pref_flowgate_ai_fallback_profile"
    const val PREF_FLOWGATE_AI_AUTONOMY = "pref_flowgate_ai_autonomy"
    const val PREF_FLOWGATE_AI_LOG_LEVEL = "pref_flowgate_ai_log_level"
    const val PREF_FLOWGATE_AI_LAST_PLAN = "pref_flowgate_ai_last_plan"
    const val PREF_FLOWGATE_AI_CHAT_HISTORY = "pref_flowgate_ai_chat_history"
    const val PREF_FLOWGATE_ROUTE_MODE = "pref_flowgate_route_mode"
    const val PREF_FLOWGATE_CONNECTION_STATE = "pref_flowgate_connection_state"
    const val PREF_FLOWGATE_ADAPTIVE_SERVICE_TARGETS = "pref_flowgate_adaptive_service_targets"
    const val PREF_FLOWGATE_SERVICE_DECISIONS = "pref_flowgate_service_decisions"
    const val PREF_FLOWGATE_PROBE_HISTORY = "pref_flowgate_probe_history"
    const val PREF_FLOWGATE_CONFIG_SNAPSHOTS = "pref_flowgate_config_snapshots"
    const val PREF_FLOW_SPEED_TEST_URL = "pref_flow_speed_test_url"
    const val PREF_FLOW_SPEED_TEST_SIZE_BYTES = "pref_flow_speed_test_size_bytes"
    ...
    const val FLOW_SPEED_TEST_URL = "https://speed.cloudflare.com/__down?bytes=1048576"
    const val FLOW_SPEED_TEST_SIZE_BYTES = 1048576L
    ...
    const val RAY_NG_CHANNEL_NAME = "FlowGate Background Service"
